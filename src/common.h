...
#define DUALSENSE_ACCESS_PROFILE_STICK (0)
#define DUALSENSE_ACCESS_PROFILE_EXTENSION1 (1)
#define DUALSENSE_ACCESS_PROFILE_EXTENSION2 (2)
#define DUALSENSE_ACCESS_PROFILE_EXTENSION3 (3)
#define DUALSENSE_ACCESS_PROFILE_EXTENSION4 (4)
#define DUALSENSE_ACCESS_PROFILE_CENTER_BUTTON (8)
#define DUALSENSE_ACCESS_PROFILE_B1 (0)
#define DUALSENSE_ACCESS_PROFILE_B2 (1)
#define DUALSENSE_ACCESS_PROFILE_B3 (2)
#define DUALSENSE_ACCESS_PROFILE_B4 (3)
#define DUALSENSE_ACCESS_PROFILE_B5 (4)
#define DUALSENSE_ACCESS_PROFILE_B6 (5)
#define DUALSENSE_ACCESS_PROFILE_B7 (6)
#define DUALSENSE_ACCESS_PROFILE_B8 (7)
#define DUALSENSE_ACCESS_PROFILE_STICK_BUTTON (9)
