...
libresense_result
libresense_convert_edge_profile_input(const dualsense_profile_data input[3], libresense_edge_profile *profile) {
...
libresense_result
libresense_convert_edge_profile_output(const libresense_edge_profile input, dualsense_profile_data profile[3]) {
